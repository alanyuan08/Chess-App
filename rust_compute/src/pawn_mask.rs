...
pub fn white_pawn_moves(
    ...
    while promotion_move != 0 {
        ...
        moves.push(ForwardMove { 
            start_sq: target - 8, 
            end_sq: target, 
            move_type: MoveFlag::PROMOTIONQUEEN, 
            pv_score: 90_000 
        });
        ...
        moves.push(ForwardMove { 
            start_sq: target - 8, 
            end_sq: target, 
            move_type: MoveFlag::PROMOTIONROOK, 
            pv_score: -500 
        });
        moves.push(ForwardMove { 
            start_sq: target - 8, 
            end_sq: target, 
            move_type: MoveFlag::PROMOTIONBISHOP, 
            pv_score: -500 
        });
        moves.push(ForwardMove { 
            start_sq: target - 8, 
            end_sq: target, 
            move_type: MoveFlag::PROMOTIONKNIGHT, 
            pv_score: -500 
        });
    ...
    while left_capture_no_promotion != 0 {
        ...
        let pv_score = 10_000 + (captured_piece_val * 10) - 100; 
