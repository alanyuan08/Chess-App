...
- **NNUE Architecture:** The engine features a customized **HalfPK** perspective neural network utilizing a hybrid quantization layout. The architectural data pathways progress as follows:
